...
const long EasyRoutingFrame::ID_STATICBOX1 = wxNewId();
...
EasyRoutingFrame::EasyRoutingFrame(wxWindow* parent,wxWindowID id)
{
    ...
    StaticBoxSizer2 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("Map"));
    StaticBoxSizer2->Add(492,378,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    BoxSizer1->Add(StaticBoxSizer2, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    BoxSizer2 = new wxBoxSizer(wxVERTICAL);
    StaticBox1 = new wxStaticBox(this, ID_STATICBOX1, _("Routes"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICBOX1"));
    BoxSizer2->Add(StaticBox1, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    StaticBoxSizer1->Add(BoxSizer3, 1, wxALL|wxALIGN_RIGHT, 5);
    ...
    StaticBoxSizer1->Add(BoxSizer5, 1, wxALL|wxALIGN_RIGHT, 5);
    ...
    BoxSizer2->Add(StaticBoxSizer1, 1, wxALL|wxALIGN_CENTER_HORIZONTAL, 5);
